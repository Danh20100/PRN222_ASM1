# EduBot — RAG Chatbot for Vietnamese Education

> **PRN222 Assignment — EduBot System**
...
```bash
git clone https://github.com/YOUR_USERNAME/Assignment_prn222.git
cd Assignment_prn222/Assignment_prn222
```
